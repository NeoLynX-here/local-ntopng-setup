...
Only **ntopng Community** is free and fully functional out of the box. `nprobe`, `cento`, `n2disk`, and `ntap` are commercial products that run in a demo/limited mode without a purchased license.
